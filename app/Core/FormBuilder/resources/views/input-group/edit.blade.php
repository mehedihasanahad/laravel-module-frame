...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Input Group</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Edit Input Group</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Input Group</h3>
            </div>
            <form id="quickForm" method="POST" action="{{ route('input-group.update',\App\Libraries\Encryption::encodeId($inputGroup->id)) }}">
                @method('PUT')
                @csrf
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control validation" name="form_id" id="form_id">
                                    ...
                                    @foreach($forms as $form)
                                        <option
                                            value="{{$form->id}}" @selected(old('form_id',$inputGroup->form_id) == $form->id)>{{$form->title}}</option>
                                    @endforeach
                                </select>
                                @error('form_id')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control validation" name="component_id" id="component_id">
                                    ...
                                    @foreach($components as $component)
                                        <option
                                            value="{{$component->id}}"
                                            @selected(old('component_id',$inputGroup->component_id) == $component->id)>{{$component->title}}</option>
                                    @endforeach
                                </select>
                                @error('component_id')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="step_no" id="step_no"
                                       ...
                                       value="{{old('step_no',$inputGroup->step_no)}}">
                                @error('step_no')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control validation" name="label" id="label"
                                       ...
                                       value="{{old('label',$inputGroup->label)}}">
                                @error('label')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="value" id="value"
                                       ...
                                       value="{{old('value',$inputGroup->value)}}">
                                @error('value')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
