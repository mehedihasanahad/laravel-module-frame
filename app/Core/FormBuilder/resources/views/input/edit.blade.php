...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Input</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <form id="quickForm" method="POST" x-data="data" @submit.prevent="updateInput()">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control validation" name="component_id" id="component_id"
                                    ...
                                    @foreach($components as $component)
                                        <option
                                            value="{{$component->id}}" @selected(old('component_id',$data['component_id']) == $component->id)>{{$component->title}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="group_id" id="group_id"
                                    ...
                                    <option selected disabled value="{{null}}">Select Input Group</option>
                                    @foreach($inputGroups as $inputGroup)
                                        <option
                                            value="{{$inputGroup->id}}" @selected(old('group_id',$data['group_id']) == $inputGroup->id)>{{$inputGroup->label}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="is_loop" id="is_loop"
    ...
    <script>
        function data() {
            return {
                ...
                updateInput() {
                    axios.patch('{{route('input.update',$data['id'])}}', {
                        ...this.formData
                    })
                        .then(response => {
