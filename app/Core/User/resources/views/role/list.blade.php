        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h4>Roles</h4>
                        <!-- Breadcrumb -->
                        @includeIf('Dashboard::admin.subviews.breadcrumb', ['active_module_name' => 'Roles'])
                    </div>
                    <div class="col d-flex justify-content-end align-items-center">
                        <a href="{{route('roles.create')}}" class="btn btn-sm btn-secondary">Create Role</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <table id="table_desk" class="table table-striped table-bordered display"
                    ...
                    <thead>
                    <tr>
                        <th>{{ __('User::messages.roles.sl') }}</th>
                        <th>{{ __('User::messages.roles.name') }}</th>
                        <th>{{ __('User::messages.roles.guard_name') }}</th>
