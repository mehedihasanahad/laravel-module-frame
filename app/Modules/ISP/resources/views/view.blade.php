...
{{--                            <label for="company_org_name" class="col-md-4">Company / Organization Name</label>--}}
{{--                            <div class="col-md-8">--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_mobile" class="col-md-4">Mobile Number</label>--}}
{{--                            <div class="col-md-8">--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="company_type" class="col-md-4">Telephone No.</label>--}}
{{--                            <div class="col-md-8">--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_email" class="col-md-4">Email</label>--}}
{{--                            <div class="col-md-8">--}}
{{--                                <span>: [Email]</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_district" class="col-md-4">District</label>--}}
{{--                            <div class="col-md-8">--}}
{{--                                <span>: [District]</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_thana" class="col-md-4">Upazila / Thana</label>--}}
{{--                            <div class="col-md-8">--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_address" class="col-md-4">Address</label>--}}
{{--                            <div class="col-md-8">--}}
{{--                                <span>: [Address]</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                    <div class="col-md-6">--}}
{{--                        <div class="form-group row">--}}
{{--                            <label for="applicant_website" class="col-md-4">Website</label>--}}
{{--                            <div class="col-md-8">--}}
{{--                                <span>: [Website]</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_name required"
                                   ...
                                   name="shareholder_name" type="text" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_designation required"
                                   ...
                                   id="shareholder_designation" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_email required email"
                                   ...
                                   name="shareholder_email" type="text" readonly
                        ...
                        <div class="col-md-8  ">
                            <div class="input-group">
                                ...
                                <input
                                    ...
                                    name="shareholder_mobile" type="text" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_share_of required digits"
                                   ...
                                   name="shareholder_share_of" type="number" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control no-of-share required"
                                   ...
                                   name="no_of_share" type="number" readonly
                    ...
                    <div class="form-group row" id="nidBlock_1" style="display: none;">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_nid"
                                   ...
                                   name="shareholder_nid" type="text" readonly
                    ...
                    <div class="form-group row" id="passportBlock_1" style="display: none;">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control shareholder_passport"
                                   ...
                                   name="shareholder_passport" type="text" readonly
                        ...
                        <div class="col-md-8 ">
                            <div class="input-group date datetimepicker4" id="datepicker0"
                                ...
                                <input class="form-control shareholder_dob required date"
                                       ...
                                       name="shareholder_dob" type="date" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <input class="form-control share-value required"
                                   ...
                                   name="share_value" type="number" readonly
