<div class="card card-success">
    ...
    <form id="quickForm" method="POST" action="{{route('isp-license.store')}}">
        @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 ">
                            <select class="form-control shareholder_nationality required"
                                ...
                                <option value="22">Netherland</option>
                                <option value="166">New Zealander</option>
                                ...
                                <option value="210">Seychellois</option>
                                <option value="211">Sierra Leonian</option>
