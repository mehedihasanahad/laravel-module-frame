...
<script src="{{ asset("assets/js/facedetection.js") }}" type="text/javascript"></script>
...
<script>
    ...
    */
    ...
    function resetImage(input_details, elem) {
        ...
        document.getElementById(input[2]).setAttribute('src', '{{ url('assets/images/adminLTE/avatar.png') }}');
        elem.remove();
    }
